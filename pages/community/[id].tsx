...
interface AnswerWitheUser extends Answer {
  user: User;
}
    ...
    <Layout canGoBack>
      <div>
        ...
        <div>
          ...
          <div onClick={onWonderClick} className="flex px-4 space-x-5 mt-3 text-gray-700 py-2.5 border-t border-b-[2px]  w-full">
            <button
              className={
                cls("flex space-x-2 items-center text-sm", data?.isWondering ? "text-teal-600" : "")
            }>
              <svg
                className="w-4 h-4"
                fill="none"
