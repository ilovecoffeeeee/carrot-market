...
const EditProfile: NextPage = () => {
  ...
  useEffect(() => {
    ...
    if(user?.avatar) setAvatarPreview(`https://imagedelivery.net/47bencKIdr1rB9sMj1Ihig/${user?.avatar}/avatar`);
  }, [user, setValue])
    ...
    <Layout canGoBack title="Edit Profile">
      <form onSubmit={handleSubmit(onValid)} className="py-10 px-4 space-y-4">
        ...
        <Input
          ...
          kind="phone"
        />
        {errors.formErrors ? <span className="my-2 text-red-500 font-bold block text-center">{errors.formErrors.message}</span> : null}
