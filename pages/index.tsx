              ...
              [1, 2, 3, 4, 5].map((i) => (
                <div key={i}
                  className="flex justify-between my-2
                   odd:bg-blue-100 even:bg-yellow-100"
                >
                <span className="text-gray-500">Grey Chair No.{i}</span>
        ...
        <div className="bg-white dark overflow-hidden rounded-2xl shadow-xl group">
          ...
          <div className="rounded-3xl p-6 bg-white relative -top-5">
            ...
            <div className="relative flex flex-col items-center -mt-10 -mb-5">
              <span className="text-lg font-medium">Sun Kim</span>
              <span className="text-sm text-gray-500">Russia</span>
            </div>
          </div>
        </div>
        <div className="bg-white dark p-10 rounded-2xl shadow-xl lg:col-span-2 xl:col-span-1">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex justify-between items-center">
              <span className="font-medium text-2xl ">$45</span>
